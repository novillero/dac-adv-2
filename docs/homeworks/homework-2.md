...
7. Перейдите в [GitHub → Pull requests](https://github.com/novillero/dac-adv-2/pulls){target=_blank} и создайте Pull Request из вашей рабочей ветки в ветку `master`.
